...
/// target repos never inherit DotnetDeployer.Fleet's own root <c>Directory.Packages.props</c>
/// (Central Package Management) when the worker happens to be running from
/// inside the DotnetDeployer.Fleet source tree.
/// </summary>
/// <remarks>
...
public static class RepoStorageIsolator
{
    private const string ManagedHeader =
        "<!-- Managed by DotnetDeployer.Fleet. Do not edit; this file is regenerated on worker startup. -->";
    ...
    /// needed. Always overwrites: the files are owned by DotnetDeployer.Fleet.
    /// </summary>
